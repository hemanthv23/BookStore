        ...
        >
            ...
            >
                <AiOutlineClose
                    ...
                    onClick={onClose}
                />
                <h2 className="w-fit px-4 py-1 bg-gradient-to-r from-green-400 to-blue-400 rounded-lg text-white font-bold">
                    {book.publishYear}
                </h2>
                <h4 className="my-2 text-gray-500">{book._id}</h4>
                <div className="flex justify-start items-center gap-x-2">
                    <PiBookOpenTextLight className="text-green-400 text-2xl" />
